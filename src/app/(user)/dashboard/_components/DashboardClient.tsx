	...
	return (
		<div className='flex flex-col gap-4  w-full'>
			<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
				<div className='bg-black rounded-md p-5 flex flex-col gap-6  border-gray-300'>
					...
					<div className='flex flex-col gap-1'>
						...
						<div className='bg-green-600/20 text-white rounded-md p-2 py-1 w-full'>
					...
					<div className='grid grid-cols-3 gap-2'>
						<div className='col-span-2 space-y-2'>
							...
							<div className='w-full h-[10px] bg-gray-300 rounded-full mb-4'>
								<div className='h-[10px] bg-green-500 rounded-full w-1/2'></div>
							</div>
							<Link
								href='/dashboard/transaction-history'
								className='text-sm bg-green-500 text-white rounded-md p-2 w-[170px] text-center mt-2'
							>
								View Transactions
							</Link>
						</div>
			...
			<div className='grid grid-cols-1 lg:grid-cols-2 gap-4  bg-black rounded-md p-5'>
				<div className='clr-grad-1 border border-gray-200 gap-4 flex flex-col rounded-md  items-center py-5'>
					<h3 className='text-2xl uppercase font-semibold text-center'>
						Refer a friend and earn 10% of their every deposit
					</h3>
				...
				<div className='flex flex-col gap-4 items-center justify-center'>
					<p className='font-medium text-center'>
						Achieveing success is a journey, not a destination.
					</p>
					<Link
						href='/dashboard/deposit'
						className='text-sm bg-green-500 text-white rounded-md p-2 w-[150px] text-center hover:bg-green-600 transition-all duration-300'
					>
						Invest now
					</Link>
				</div>
